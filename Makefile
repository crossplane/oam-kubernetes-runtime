...
LEGACY_HELM_CHARTS_DIR=$(ROOT_DIR)/legacy/charts
LEGACY_HELM_CHARTS = oam-kubernetes-runtime-legacy
...
prepare-legacy-chart:
	rsync -r $(LEGACY_HELM_CHARTS_DIR)/$(LEGACY_HELM_CHARTS) $(HELM_CHARTS_DIR)
