pipeline {
    ...
    environment {
        ...
        CODECOV_TOKEN = credentials('codecov-oam-runtime')
    }
            ...
            steps {
                script {
                    if (env.CHANGE_ID != null) {
                        def json = sh (script: "curl -s https://api.github.com/repos/crossplane/oam-kubernetes-runtime/pulls/${env.CHANGE_ID}", returnStdout: true).trim()
