...
func (in *DataInputValueFrom) DeepCopyInto(out *DataInputValueFrom) {
	*out = *in
	if in.Matchers != nil {
		...
		*out = make([]DataMatcherRequirement, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataMatcherRequirement) DeepCopyInto(out *DataMatcherRequirement) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataMatcherRequirement.
func (in *DataMatcherRequirement) DeepCopy() *DataMatcherRequirement {
	if in == nil {
		return nil
	}
	out := new(DataMatcherRequirement)
	in.DeepCopyInto(out)
	return out
}
